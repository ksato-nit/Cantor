...
Mumford Mumford::CostelloScalarMultiple (const boost::multiprecision::int1024_t& k_) const{
    Polynomial f = this->f;
    Polynomial h = this->h;
...
Mumford Mumford::operator * (const boost::multiprecision::int1024_t& k_) const{
    Polynomial f = this->f;
    Polynomial h = this->h;
    boost::multiprecision::int1024_t k = k_;
